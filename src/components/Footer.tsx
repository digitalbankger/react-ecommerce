    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="md:flex md:flex-row items-start md:gap-8">
          <div className="space-y-8 w-1/3">
            <div className='flex flex-row items-center'>
                <img 
                    className="h-7"
                    src="./assets/img/logo-dif.svg" 
                    alt="CardSell"
                    width={36}
                />
                <span className='font-exo text-white tracking-[1.2px] text-xl font-medium ms-1'>CardSell</span>
            </div>

            <p 
                className='w-[48%] text-lead tracking-[1px] font-exo text-lg font-extralight leading-normal mt-6 mb-10'
            >
              CardSell - предоплаченные карты MasterCard USD.
            </p>
          ...
          <div className="w-2/3 mt-10 sm:mt-0 grid grid-cols-3 gap-8 xl:col-span-3 xl:mt-0">
            <div className="md:grid md:grid-cols-1 md:gap-8">
                <div className="mt-10 md:mt-0">
                    <h3 className="text-slate-700 tracking-[0.4px] font-exo text-xl font-medium leading-normal text-white">На праздник</h3>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 font-light text-lead tracking-[0.4px]">&copy; 2023 CardSell, Все права защищены.</p>
        </div>
      </div>
    </footer>
  )
