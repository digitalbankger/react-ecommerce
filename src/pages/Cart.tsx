    ...
    return (
        ...
        >
            <div className="container flex flex-col items-end mt-10">
                ...
                <div className="w-[100%] shadow-xl shadow-slate-200 border-1 border-slate-100 rounded-[20px] p-6 text-black-600 tracking-[0.8px] font-exo text-xl font-medium leading-tight">
                    <span className='text-black-600 tracking-[0.8px] font-exo text-4xl font-medium leading-tight py-6'>Корзина</span>
                    <p className="text-lead-dark tracking-[1px] font-exo text-base font-light leading-normal my-2">В вашей корзине {cartItems.length} товар(ов) </p>
                    {cartItems.map(item => (
                        <CheckoutItem key={item.id} {...item} />
                    ))}
                    <div className="flex flex-col border-t-1 border-lead-dark ">
                        <div className="flex flex-row justify-between w-[100%] py-5">
                            <span className="font-exo text-2xl">Общая стоимость:</span>
                            <span className="font-exo text-2xl">
