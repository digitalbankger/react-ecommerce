  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center mt-10">
        <div className="w-[100%] mx-auto px-4 pb-16 pt-4 sm:px-6 sm:pb-24 sm:pt-8 lg:px-8 xl:px-2 xl:pt-14 border-1 border-slate-100 shadow-xl shadow-slate-200 rounded-[20px]">
